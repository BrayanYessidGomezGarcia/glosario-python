...
def menuCamper():
    while True:
        try:
            ...
            print("5. Campers en Riesgo Bajo")
            print("6. Salir")
...
def buscarCamper():
    ...
    for camper in campers:
        if camper['NombreCamper'] == nombre_buscar:
            ...
            print(f"Nombre del Acudiente: {camper['AcudienteCamper']['NombreAcudiente']}")
            print(f"Identificacion del Acudiente: {camper['AcudienteCamper']['idAcudiente']}")
